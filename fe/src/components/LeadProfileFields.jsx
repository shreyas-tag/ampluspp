...
function LeadProfileFields({ form, setForm, showOperationalFields = true }) {
  ...
  return (
    <>
      ...
      <label className="full-row">
        Address
        <textarea rows={2} value={form.address} onChange={setValue('address')} />
      </label>
      <label>
        Taluka / Tehsil
      ...
      <label>
        City
        <input value={form.city} onChange={setValue('city')} />
      </label>
      <label>
        State
        <input value={form.state} onChange={setValue('state')} />
      </label>
      <SelectField
      ...
      <label>
        ...
        <input type="number" min={0} step="0.01" value={form.investmentBuildingConstruction} onChange={setValue('investmentBuildingConstruction')} />
      </label>
      <label>
        Investment in Land
      ...
      <SelectField label="What is the Type of Your Project?" value={form.projectType} onChange={setValue('projectType')} options={leadSelectOptions.projectType} />
      <SelectField
      ...
      {showOperationalFields ? (
        <>
          <SelectField label="Source" value={form.source} onChange={setValue('source')} options={leadSelectOptions.source} />
          <SelectField
